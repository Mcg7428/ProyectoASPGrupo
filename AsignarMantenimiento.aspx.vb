...
Partial Class AsignarMantenimiento
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If (DateDiff(DateInterval.Day, Calendar1.SelectedDate, Calendar2.SelectedDate) >= 0) Then
            fechaini = Calendar1.SelectedDate.Date
            fechafinal = Calendar2.SelectedDate.Date
        ...
        comandoSqlE2 = New SqlClient.SqlCommand(consulta2, cn) '' creando objeto consulta a la base de datos con objeto conexio
